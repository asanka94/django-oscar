...
class SearchTestCase(TestCase):
    ...
    def test_aggregation_skipped_if_search_setting_AGGREGATE_SEARCH_is_false(self):
        ...
        OSCAR_SEARCH['SEARCHES']['TEST_SEARCH']['facets'] = {
            'manufacturer': {
                'type': 'terms',
                'label': 'Manufacturer',
        ...
        OSCAR_SEARCH['SEARCHES']['TEST_SEARCH']['aggregate_search'] = False
        ...
        OSCAR_SEARCH['SEARCHES']['TEST_SEARCH']['aggregate_search'] = True
        with override_settings(OSCAR_SEARCH=OSCAR_SEARCH):
            test_search = Search()
            test_search.aggregate(search_mock)
    ...
    def test_extract_facets_adds_processed_auto_ranges_to_return_value(self):
        ...
        test_search = Search()
        extracted_facets = test_search.extract_facets(results, [facet_name])
    ...
    def test_parse_results_adds_facets_if_aggregate_search_is_True(self):
        ...
        self.assertEqual(
            ...
            test_search.extract_facets(results, [facet_name])
        )
